...
public class Variable01 {
	...
	public static void main(String[] args) {
		...
		int floor;  // 정수형 숫자 담을 공간 (공간 이름 floor)
...
//		
		...
		//hour = 15; // 변수 선언 이전에 사용 불가 
		
		int hour = 14; // 정수형 숫자  변수 선언 + 값 저장 -> 초기화  공간(변수)이름: hour
...
//		seconds = 31; //선언 안한 변수 사용 불가
		...
		//출력문 
		//System.out.println(괄호안에 있는 값/문자 출력);
		System.out.println("안녕하세요");
		System.out.println(500);
		System.out.println(totalScore);
		System.out.println(2*60 + 43); // sysoout-> Ctrl + Space 자동완성
